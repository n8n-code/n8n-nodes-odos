...
export class OdosApi implements ICredentialType {
	name = 'N8nDevOdosApi';

	displayName = 'odos API';

	icon: Icon = { light: 'file:../nodes/Odos/odos.svg', dark: 'file:../nodes/Odos/odos.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your odos API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
